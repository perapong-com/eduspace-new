...
const CATEGORIES = ['ทั้งหมด', 'เภสัชวิทยา', 'การบริบาลเภสัชกรรม', 'กฎหมายและจริยธรรม', 'บริหารเภสัชกิจ'];
                            ...
                            <div className="col-xl-3 col-lg-4">
                                <div className="courses-main-sidebar-area">
                                    ...
                                    <button onClick={clearFilters} className="theme-btn">
                                        <i className="far fa-times-circle"></i> {t('ล้างตัวกรอง', 'Clear Filters')}
                                    </button>
                                </div>
                            </div>
