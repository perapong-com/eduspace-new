                                    ...
                                    <div className="col-lg-8">
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{
                                                ...
                                                {[
                                                    { key: 'notes', label: '📝 บันทึกของฉัน' },
                                                    { key: 'resources', label: '📄 เอกสาร' },
                                                    { key: 'qa', label: '💬 ถาม-ตอบ' },
                                                ].map((tab) => (
                                                    <button
                                                        key={tab.key}
                                                        onClick={() => setActiveTab(tab.key as 'notes' | 'resources' | 'qa')}
                                                        style={{
                                                            flex: 1,
                                                            padding: '16px',
                                                            border: 'none',
                                                            background: activeTab === tab.key ? '#fff' : 'transparent',
                                                            color: activeTab === tab.key ? '#014D40' : '#666',
                                                            fontWeight: activeTab === tab.key ? '600' : '500',
                                                            cursor: 'pointer',
                                                            borderBottom: activeTab === tab.key ? '3px solid #014D40' : '3px solid transparent',
                                                            transition: 'all 0.2s ease',
                                                            fontSize: '14px'
                                                        }}
                                                    >
                                                        ...
                                                        {notes.map((note) => (
                                                            ...
                                                            >
                                                                <div>
                                                                    ...
                                                                    <span style={{ color: '#333', fontSize: '14px' }}>{note.text}</span>
                                                                </div>
                                                                <button onClick={() => handleDeleteNote(note.id)} style={{ background: 'none', border: 'none', color: '#999', cursor: 'pointer' }}>
                                                    ...
                                                    <div>
                                                        {qaItems.map((item) => (
                                                            <div key={item.id} style={{
                                                                ...
                                                                <p style={{ fontWeight: '500', color: '#014D40', marginBottom: '8px' }}>{item.question}</p>
                                                                <div style={{ background: '#e8f8f4', padding: '12px', borderRadius: '8px', borderLeft: '3px solid #40C7A9' }}>
                                                                    <p style={{ margin: 0, fontSize: '14px' }}>{item.answer}</p>
                                                                </div>
                                                                <div style={{ marginTop: '8px', fontSize: '12px', color: '#888' }}>
                                                                    <span>{item.author}</span> • <span>{item.time}</span> • <span>👍 {item.likes}</span>
                                                                </div>
                                                            </div>
                                                        ))}
                                                    </div>
