                ...
                <div className="row justify-content-center">
                    <div className="col-lg-6 col-md-8">
                        <div className="result-wrapper text-center" style={{
                            ...
                            <h2 style={{ color: '#AD0119', marginBottom: '15px' }}>{t('การชำระเงินไม่สำเร็จ', 'Payment Failed')}</h2>
                            <p style={{ color: '#666', marginBottom: '30px' }}>
                                {t('เกิดข้อผิดพลาดระหว่างการชำระเงิน กรุณาลองใหม่อีกครั้ง', 'An error occurred during payment. Please try again.')}
                            </p>
                            ...
                            <div className="error-details" style={{
                                ...
                                <p style={{ color: '#AD0119', marginBottom: '0' }}>
                                    ...
                                    {t('บัตรถูกปฏิเสธ กรุณาตรวจสอบข้อมูลบัตรหรือลองใช้บัตรใบอื่น', 'Card declined. Please check your card details or try a different card.')}
                                </p>
                            </div>
                            ...
                            <div className="d-flex gap-3 justify-content-center flex-wrap">
                                ...
                                <Link href="/payment-qr" className="theme-btn" style={{
                                    ...
                                    {t('ชำระผ่าน QR Code', 'Pay via QR Code')}
                                </Link>
                            </div>
                            ...
                            <div className="mt-4">
                                <Link href="/shop-cart" style={{ color: '#666' }}>
                                    ...
                                    {t('กลับไปตะกร้าสินค้า', 'Back to Cart')}
                                </Link>
                            </div>
                        </div>
                    </div>
