                ...
                <div className="row g-4">
                    ...
                    <div className="col-lg-7">
                        <div className="card-form-wrapper" style={{
                            ...
                            <h4 style={{ color: '#014D40', marginBottom: '24px' }}>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <button
                                    ...
                                    style={{
                                        width: '100%',
                                        padding: '16px',
                                        background: isProcessing ? '#ccc' : '#40C7A9',
                                        color: '#fff',
                                        border: 'none',
                                        borderRadius: '12px',
                                        fontSize: '16px',
                            ...
                            <div className="mt-4 p-3" style={{
                                ...
                                <i className="fas fa-lock" style={{ color: '#40C7A9', fontSize: '20px' }}></i>
                                <div>
                    ...
                    <div className="col-lg-5">
                        <div className="order-summary-wrapper" style={{
                            ...
                            <div className="d-flex justify-content-between mb-2">
                                ...
                                <span style={{ color: '#40C7A9' }}>-฿0</span>
                            </div>
