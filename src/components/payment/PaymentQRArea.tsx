                ...
                <div className="row justify-content-center">
                    <div className="col-lg-6 col-md-8">
                        <div className="qr-wrapper text-center" style={{
                            ...
                            <h3 style={{ color: '#004736', marginBottom: '10px' }}>{t('ชำระเงินผ่าน QR Code', 'Pay via QR Code')}</h3>
                            <p style={{ color: '#666', marginBottom: '30px' }}>{t('สแกน QR Code เพื่อชำระเงิน', 'Scan QR Code to make payment')}</p>
                            ...
                            <div className="payment-info" style={{
                                ...
                                <div className="d-flex justify-content-between mb-2">
                                    <span style={{ color: '#666' }}>{t('ยอดชำระ', 'Amount')}</span>
                                    <strong style={{ color: '#004736', fontSize: '24px' }}>฿1,500</strong>
                                </div>
                                <div className="d-flex justify-content-between">
                                    <span style={{ color: '#666' }}>{t('รหัสอ้างอิง', 'Reference')}</span>
                                    <span style={{ color: '#004736' }}>PA-2024-001234</span>
                                </div>
                            </div>

                            <div className="timer" style={{ marginBottom: '20px' }}>
                                <p style={{ color: '#666' }}>{t('QR Code จะหมดอายุใน', 'QR Code expires in')}</p>
                            ...
                            >
                                {t('ฉันชำระเงินแล้ว', 'I have made the payment')}
                            </Link>

                            <div className="mt-4">
                                <Link href="/checkout" style={{ color: '#004736' }}>
                                    <i className="fas fa-credit-card me-2"></i>
                                    {t('ชำระด้วยบัตรเครดิตแทน', 'Pay with Credit Card instead')}
                                </Link>
                            </div>
                        </div>
                    </div>
